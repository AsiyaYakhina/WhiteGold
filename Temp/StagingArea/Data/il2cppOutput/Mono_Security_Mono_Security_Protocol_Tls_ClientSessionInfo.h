...
struct  ClientSessionInfo_t684  : public Object_t
{
	...
	ByteU5BU5D_t589* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t589* ___masterSecret_5;
};
struct ClientSessionInfo_t684_StaticFields{
